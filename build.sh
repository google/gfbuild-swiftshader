...
GH_RELEASE_TOOL_USER="paulthomson"
GH_RELEASE_TOOL_VERSION="v1.1.0.2"
...
CMAKE_OPTIONS+=("-DSWIFTSHADER_BUILD_EGL=0" "-DSWIFTSHADER_BUILD_GLESv2=0" "-DSWIFTSHADER_BUILD_GLES_CM=0" "-DSWIFTSHADER_BUILD_SAMPLES=0" "-DSWIFTSHADER_BUILD_TESTS=0" "-DSWIFTSHADER_WARNINGS_AS_ERRORS=0" "-DSWIFTSHADER_LESS_DEBUG_INFO=1")
...
case "$(uname)" in
"Linux")
  SWIFT_SHADER_PLATFORM_OUTPUT="Linux"
  ;;
