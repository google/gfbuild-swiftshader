...
CMAKE_OPTIONS+=("-DLESS_DEBUG_INFO=1" "-DBUILD_EGL=0" "-DBUILD_GLESv2=0" "-DBUILD_GLES_CM=0" "-DBUILD_SAMPLES=0" "-DBUILD_TESTS=0" "-DWARNINGS_AS_ERRORS=0")

git clone --recurse-submodules "https://${TARGET_REPO_ORG}.googlesource.com/${TARGET_REPO_NAME}" "${TARGET_REPO_NAME}"
cd "${TARGET_REPO_NAME}"
